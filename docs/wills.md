...
The durable bundle is a versioned encoding on local disk. Chains or IPFS may store objects, will text, and snapshot hashes later. No chain adapter ships in this repository. Contracts, if introduced later, execute already-written wills; they do not draft them.
